CREATE OR REPLACE FUNCTION "public"."calculate_total_experience"("p_user_id" "uuid", "p_trade_filter" "text" DEFAULT NULL::"text") RETURNS integer
...
ALTER FUNCTION "public"."calculate_total_experience"("p_user_id" "uuid", "p_trade_filter" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."can_access_pro_features"("user_id" "uuid") RETURNS boolean
...
ALTER FUNCTION "public"."can_access_pro_features"("user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."check_credential_category"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  user_role TEXT;
...
ALTER FUNCTION "public"."check_credential_category"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."check_portfolio_limit"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  current_count int;
...
ALTER FUNCTION "public"."check_portfolio_limit"() OWNER TO "postgres";


COMMENT ON FUNCTION "public"."check_portfolio_limit"() IS 'Atomically checks portfolio photo count limit based on subscription status before insert';
...
CREATE OR REPLACE FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_pay_rate" "text", "p_sub_trade" "text" DEFAULT NULL::"text", "p_pay_min" numeric DEFAULT NULL::numeric, "p_pay_max" numeric DEFAULT NULL::numeric, "p_required_certs" "text"[] DEFAULT NULL::"text"[], "p_time_length" "text" DEFAULT NULL::"text", "p_trades" "text"[] DEFAULT NULL::"text"[], "p_sub_trades" "text"[] DEFAULT NULL::"text"[], "p_trade_selections" "jsonb" DEFAULT NULL::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  new_job_id UUID;
...
ALTER FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_pay_rate" "text", "p_sub_trade" "text", "p_pay_min" numeric, "p_pay_max" numeric, "p_required_certs" "text"[], "p_time_length" "text", "p_trades" "text"[], "p_sub_trades" "text"[], "p_trade_selections" "jsonb") OWNER TO "postgres";


COMMENT ON FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_pay_rate" "text", "p_sub_trade" "text", "p_pay_min" numeric, "p_pay_max" numeric, "p_required_certs" "text"[], "p_time_length" "text", "p_trades" "text"[], "p_sub_trades" "text"[], "p_trade_selections" "jsonb") IS 'Creates a job with PostGIS coordinates. Supports structured trade_selections (JSONB) with backward compatibility for arrays.';



CREATE OR REPLACE FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" numeric, "p_lat" numeric, "p_pay_rate" "text", "p_sub_trade" "text" DEFAULT NULL::"text", "p_pay_min" numeric DEFAULT NULL::numeric, "p_pay_max" numeric DEFAULT NULL::numeric, "p_required_certs" "text"[] DEFAULT NULL::"text"[], "p_time_length" "text" DEFAULT NULL::"text", "p_trades" "text"[] DEFAULT NULL::"text"[], "p_sub_trades" "text"[] DEFAULT NULL::"text"[], "p_trade_selections" "jsonb" DEFAULT NULL::"jsonb", "p_custom_questions" "jsonb" DEFAULT NULL::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_job_id UUID;
...
ALTER FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" numeric, "p_lat" numeric, "p_pay_rate" "text", "p_sub_trade" "text", "p_pay_min" numeric, "p_pay_max" numeric, "p_required_certs" "text"[], "p_time_length" "text", "p_trades" "text"[], "p_sub_trades" "text"[], "p_trade_selections" "jsonb", "p_custom_questions" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" numeric, "p_lat" numeric, "p_pay_rate" "text", "p_sub_trade" "text" DEFAULT NULL::"text", "p_pay_min" numeric DEFAULT NULL::numeric, "p_pay_max" numeric DEFAULT NULL::numeric, "p_subtrade_pay_rates" "jsonb" DEFAULT NULL::"jsonb", "p_required_certs" "text"[] DEFAULT NULL::"text"[], "p_time_length" "text" DEFAULT NULL::"text", "p_trades" "text"[] DEFAULT NULL::"text"[], "p_sub_trades" "text"[] DEFAULT NULL::"text"[], "p_trade_selections" "jsonb" DEFAULT NULL::"jsonb", "p_custom_questions" "jsonb" DEFAULT NULL::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
  v_job_id UUID;
...
ALTER FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" numeric, "p_lat" numeric, "p_pay_rate" "text", "p_sub_trade" "text", "p_pay_min" numeric, "p_pay_max" numeric, "p_subtrade_pay_rates" "jsonb", "p_required_certs" "text"[], "p_time_length" "text", "p_trades" "text"[], "p_sub_trades" "text"[], "p_trade_selections" "jsonb", "p_custom_questions" "jsonb") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."get_nearby_jobs"("user_lng" double precision, "user_lat" double precision, "radius_km" double precision DEFAULT 25) RETURNS TABLE("id" "uuid", "employer_id" "uuid", "title" "text", "trade" "text", "sub_trade" "text", "job_type" "text", "description" "text", "location" "text", "pay_rate" "text", "pay_min" numeric, "pay_max" numeric, "required_certs" "text"[], "status" "text", "view_count" integer, "application_count" integer, "created_at" timestamp with time zone, "distance_km" double precision)
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_nearby_jobs"("user_lng" double precision, "user_lat" double precision, "radius_km" double precision) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_workers_by_experience"("p_min_years" integer DEFAULT 0, "p_trade_filter" "text" DEFAULT NULL::"text", "p_limit_count" integer DEFAULT 50) RETURNS TABLE("id" "uuid", "name" "text", "trade" "text", "sub_trade" "text", "location" "text", "coords" "public"."geography", "total_experience_years" integer, "subscription_status" "text", "is_profile_boosted" boolean)
    LANGUAGE "plpgsql" STABLE
    AS $$
BEGIN
  RETURN QUERY
...
ALTER FUNCTION "public"."get_workers_by_experience"("p_min_years" integer, "p_trade_filter" "text", "p_limit_count" integer) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."increment_application_count"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  UPDATE jobs
...
ALTER FUNCTION "public"."increment_application_count"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."increment_job_view_count"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  UPDATE jobs
...
ALTER FUNCTION "public"."increment_job_view_count"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."mark_conversation_read"("conversation_id" "uuid", "user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  UPDATE messages
...
ALTER FUNCTION "public"."mark_conversation_read"("conversation_id" "uuid", "user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."st_distance"("geog1" "jsonb", "geog2" "jsonb") RETURNS double precision
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  point1 geography;
...
BEGIN
  ...
  -- Return distance in meters and miles setting switch to measure distance in km or mi
  RETURN ST_Distance(point1, point2);
END;
$$;


ALTER FUNCTION "public"."st_distance"("geog1" "jsonb", "geog2" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_profile_coords"("p_user_id" "uuid", "p_name" "text", "p_phone" "text", "p_email" "text", "p_role" "text", "p_trade" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_bio" "text", "p_sub_trade" "text" DEFAULT NULL::"text", "p_employer_type" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$                                                                                                                                                     
  BEGIN                                                                                                                                                     
    UPDATE profiles                                                                                                                                         
...
ALTER FUNCTION "public"."update_profile_coords"("p_user_id" "uuid", "p_name" "text", "p_phone" "text", "p_email" "text", "p_role" "text", "p_trade" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_bio" "text", "p_sub_trade" "text", "p_employer_type" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_profile_coords_only"("p_user_id" "uuid", "p_lng" double precision, "p_lat" double precision) RETURNS "void"
    LANGUAGE "plpgsql"
    AS $$                                                                                                                                                     
  BEGIN                                                                                                                                                     
    UPDATE profiles                                                                                                                                         
...
ALTER FUNCTION "public"."update_profile_coords_only"("p_user_id" "uuid", "p_lng" double precision, "p_lat" double precision) OWNER TO "postgres";


COMMENT ON FUNCTION "public"."update_profile_coords_only"("p_user_id" "uuid", "p_lng" double precision, "p_lat" double precision) IS 'Updates only the coords field of a profile with PostGIS geometry';
...
COMMENT ON COLUMN "public"."admin_activity_log"."action" IS 'Action type: verified_cert, rejected_cert, banned_user, etc.';



COMMENT ON COLUMN "public"."admin_activity_log"."target_type" IS 'Target type: certification, user, job, application, etc.';



COMMENT ON COLUMN "public"."admin_activity_log"."details" IS 'Flexible JSONB field for action-specific data';
...
COMMENT ON TABLE "public"."analytics_events" IS 'Custom analytics event tracking';



COMMENT ON COLUMN "public"."analytics_events"."event_type" IS 'Event: page_view, job_view, application_submitted, etc.';



COMMENT ON COLUMN "public"."analytics_events"."metadata" IS 'Flexible event data: {job_id, route, etc.}';
...
CREATE TABLE IF NOT EXISTS "public"."certifications" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL, /* Certification & license table */
    "user_id" "uuid" NOT NULL,    /* Certification & license table */
    "certification_type" "text" NOT NULL, /* Certification table */
    "certification_number" "text",  /* Certification table */
    "issuer" "text" NOT NULL,    /* Certification table */
    "issue_date" "date" NOT NULL,   /* Certification table */
    "cl_id" "text", /* license table(cl=contractors license) */
    "cl_type" "text"   /* license table(cl=contractors license) */
    "cl_url" "text", /* license table(cl=contractors license) */
    "issuing_state" "text",   /* license table */
    "date_issued" "text",    /* license table */
    "expire_date" "date",   /* certification & license table */
    "image_url" "text",   /* certification & license table */
    "verification_status" "text" DEFAULT 'pending'::"text", /* Certification & license table */
    "verified_at" timestamp with time zone,   /* Certification & license table */
    "verified_by" "uuid",    /* Certification & license table */
    "rejection_reason" "text",   /* Certification & license table */
    "verification_notes" "text",   /* Certification & license table */
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,/* Certification & license table */
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,/* Certification & license table */
    CONSTRAINT "certifications_credential_category_check" CHECK (("credential_category" = ANY (ARRAY['license'::"text", 'certification'::"text"]))),
...
COMMENT ON COLUMN "public"."certifications"."issue_date" IS 'Date the credential was issued';



COMMENT ON COLUMN "public"."certifications"."certification_number" IS 'License or certification number (e.g., contractor license #123456)';



COMMENT ON COLUMN "public"."certifications"."issued_by" IS 'Issuing authority (e.g., California Contractors State License Board, OSHA)';



COMMENT ON COLUMN "public"."certifications"."image_url" IS 'URL to uploaded certification photo for verification';



COMMENT ON COLUMN "public"."certifications"."credential_category" IS 'Type of credential: license (for contractors) or certification (for workers)';



COMMENT ON COLUMN "public"."certifications"."verification_status" IS 'Current verification state';



COMMENT ON COLUMN "public"."certifications"."verified_at" IS 'Timestamp when verification completed';



COMMENT ON COLUMN "public"."certifications"."verified_by" IS 'Admin user who verified (for audit trail)';



COMMENT ON COLUMN "public"."certifications"."rejection_reason" IS 'Displayed to user if rejected';



COMMENT ON COLUMN "public"."certifications"."verification_notes" IS 'Internal admin notes (not shown to user)';



COMMENT ON COLUMN "public"."certifications"."expires_at" IS 'Expiration date of the credential (NULL if no expiration)';



COMMENT ON COLUMN "public"."certifications"."issuing_state" IS 'State/jurisdiction that issued the credential (e.g., California, Texas)';
...
COMMENT ON TABLE "public"."content_reports" IS 'User-submitted content reports for moderation';



COMMENT ON COLUMN "public"."content_reports"."reported_content_type" IS 'Type: job, profile, message';



COMMENT ON COLUMN "public"."content_reports"."reason" IS 'Reason: spam, inappropriate, fraud, harassment, other';



COMMENT ON COLUMN "public"."content_reports"."action_taken" IS 'Action: content_removed, user_warned, user_banned, no_action';
...
COMMENT ON TABLE "public"."education" IS 'Worker education history for auto-filling job applications';
...
CREATE TABLE IF NOT EXISTS "public"."endorsements" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "check_recommendation_length" CHECK (("length"("recommendation_text") <= 200))
);
...
CREATE TABLE IF NOT EXISTS "public"."jobs" (
    ...
    "trades_requested" "jsonb"[],
    "sub_trades_requested" "jsonb"[], 
    "location" "text" NOT NULL,
    "coords" "public"."geography"(Point,4326),
    "job_type" "text" NOT NULL,  /* Full/Part-time, Temp, Piecework, or 1099 contracted  */
    "pay_rate" "text" NOT NULL, /* weekly, biweekly, per job, per contract */
    "trades_pay" "jsonb"[], /* Only used if subtrades arent picked, NULL if subtrades are picked  */
    "subtrades_pay" "jsonb"[],
...
COMMENT ON COLUMN "public"."jobs"."trade" IS 'DEPRECATED: Use trades array instead';



COMMENT ON COLUMN "public"."jobs"."sub_trade" IS 'DEPRECATED: Use sub_trades array instead';



COMMENT ON COLUMN "public"."jobs"."employer_name" IS 'Deprecated: Employer name is now fetched via JOIN with profiles table';



COMMENT ON COLUMN "public"."jobs"."time_length" IS 'Duration of contract or temporary job (e.g., "3 months", "6 weeks"). NULL for permanent positions.';



COMMENT ON COLUMN "public"."jobs"."trades" IS 'Array of trade categories needed for this job (e.g., ["Carpenter", "Electrician"])';



COMMENT ON COLUMN "public"."jobs"."sub_trades" IS 'Array of specialty subcategories needed (optional)';



COMMENT ON COLUMN "public"."jobs"."trade_selections" IS 'Structured trade selections: [{"trade": "Carpenter", "subTrades": ["Rough Frame", "Finish"]}]';



COMMENT ON COLUMN "public"."jobs"."subtrade_pay_rates" IS 'Pay rates for each sub-trade when multiple sub-trades selected.
...
CREATE TABLE IF NOT EXISTS "public"."notification_preferences" (
    "user_id" "uuid" NOT NULL,    /* user_id -> notifications.id */
    ...
    "email_digest" "text" DEFAULT 'immediate'::"text",
...
CREATE TABLE IF NOT EXISTS "public"."notifications" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid" NOT NULL, /* user_id -> users.id */
    "type" "text" NOT NULL,
    "title" "text" NOT NULL,
    ...
    "read_at" timestamp with time zone,
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "notifications_type_check" CHECK (("type" = ANY (ARRAY['new_job'::"text", 'message'::"text", 'application_update'::"text", 'profile_view'::"text"])))
);
...
COMMENT ON TABLE "public"."portfolio_images" IS 'Worker portfolio photos with display order and metadata';



COMMENT ON COLUMN "public"."portfolio_images"."id" IS 'Unique identifier for portfolio image';



COMMENT ON COLUMN "public"."portfolio_images"."user_id" IS 'Worker who uploaded the image';



COMMENT ON COLUMN "public"."portfolio_images"."image_url" IS 'Public URL to image in Supabase Storage';



COMMENT ON COLUMN "public"."portfolio_images"."display_order" IS 'Order for displaying images (0-indexed)';



COMMENT ON COLUMN "public"."portfolio_images"."uploaded_at" IS 'Timestamp when image was uploaded';
...
CREATE TABLE IF NOT EXISTS "public"."professional_references" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"()
); /* foreignkey "id" to "workers.id" and "contractors.id" */


ALTER TABLE "public"."professional_references" OWNER TO "postgres";


COMMENT ON TABLE "public"."professional_references" IS 'Worker professional references for auto-filling job applications';
...
CREATE TABLE IF NOT EXISTS "public"."profile_views" (
    ...
    "viewed_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "check_no_self_view" CHECK (("viewed_profile_id" <> "viewer_id"))
);
...
CREATE TABLE IF NOT EXISTS "public"."users" (
    "id" "uuid" NOT NULL,    /* USERS TABLE */
    "first_name" "text" NOT NULL,   /* USERS TABLE */
    "last_name" "text" NOT NULL,    /* USERS TABLE */
    "username" "text",      /* USERS TABLE */
    "use_username" boolean DEFAULT false   /* USERS TABLE */
    "profile_image_url" "text",    /* USERS TABLE */
    "email" "text" NOT NULL,     /* USERS TABLE */
    "phone" "text",       /* USERS TABLE */
    "age" numeric,     /* USERS TABLE */
    "date_of_birth" "text",   /* USERS TABLE */
    "role" "text" NOT NULL,   /* USERS TABLE */
    "employer_type" "text",   /* RECRUITERS/CONTRACTORS/DEVELOPERS/HOMEOWNERS TABLES */
    "trade" "text" NOT NULL,  /* WORKERS ONLY (for application purposes) */
    "sub_trade" "text",       /* WORKERS ONLY (for application purposes) */
    "location" "text" NOT NULL,   /* USERS TABLE */
    "geo_coords" "public"."geography"(Point,4326),    /* USERS TABLE */
    "bio" "text",    /* USERS TABLE */
    "subscription_status" "text" DEFAULT 'free'::"text" NOT NULL,      /* USERS TABLE */
    "company_name" "text",   /* RECRUITERS/CONTRACTORS/DEVELOPERS TABLES */
    "is_profile_boosted" boolean DEFAULT false,      /* WORKERS ONLY */
    "boost_expires_at" timestamp with time zone,     /* WORKERS ONLY */
    "address_street" "text",   /* USERS TABLE */
    "address_city" "text",    /* USERS TABLE */
    "address_state" "text",    /* USERS TABLE */
    "address_zip_code" "text",   /* USERS TABLE */
    "has_dl" boolean DEFAULT false,     /* WORKERS ONLY (for application purposes) */
    "dl_class" "text",      /* WORKERS ONLY (for application purposes) */
    "reliable_transportation" boolean DEFAULT false,   /* WORKERS ONLY (for application purposes) */
    "authorized_to_work" boolean DEFAULT false,      /* WORKERS ONLY (for application purposes) */
    "years_of_experience" integer DEFAULT 0,    /* WORKERS & CONTRACTORS TABLES */
    "trade_skills" "text"[],     /* WORKERS ONLY (for application purposes) */
    "emergency_contact_name" "text",       /* WORKERS ONLY (for application purposes) */
    "emergency_contact_relationship" "text",    /* WORKERS ONLY (for application purposes) */
    "emergency_contact_phone" "text",   /* WORKERS ONLY (for application purposes) */
    "is_admin" boolean DEFAULT false,   /* USERS TABLE */
    "can_post_jobs" boolean DEFAULT true,    /* USERS TABLE */
    "has_tools" boolean DEFAULT false,    /* WORKERS ONLY (for application purposes) */
    "tools_owned" "text"[] DEFAULT '{}'::"text"[],   /* WORKERS ONLY (for application purposes) */
    "is_lifetime_pro" boolean DEFAULT false,    /* USERS TABLE */
    "lifetime_pro_granted_at" timestamp with time zone,   /* USERS TABLE */
    "lifetime_pro_granted_by" "uuid",      /* USERS TABLE */
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,    /* USERS TABLE */
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,    /* USERS TABLE */
    
    /* NEW TABLE: workers ( foreignkey to certification table "id" to "users.id") ADDITIONAL COLUMNS: "has_certifications" boolean
                                                                                                      "has_portfolio" boolean DEFAULT false (changes to true with at least 1 photo uploaded in portfolio_images table) 
       NEW TABLE: contractors ( foreignkey to new license table "id" to "users.id" ) ADDITIONAL COLUMNS: "has_cl" boolean 
    */

    CONSTRAINT "employer_type_check" CHECK (("employer_type" = ANY (ARRAY['contractor'::"text", 'developer'::"text", 'homeowner'::"text", 'recruiter'::"text"]))),
    CONSTRAINT "dl_class_check" CHECK (("license_class" = ANY (ARRAY['A'::"text", 'B'::"text", 'C'::"text"]))),
    CONSTRAINT "role_check" CHECK (("role" = ANY (ARRAY['worker'::"text", 'employer'::"text"]))),
    CONSTRAINT "subscription_status_check" CHECK (("subscription_status" = ANY (ARRAY['free'::"text", 'pro'::"text"])))
);
...
COMMENT ON COLUMN "public"."profiles"."company_name" IS 'Business/company name for employers. NULL for workers.';



COMMENT ON COLUMN "public"."profiles"."address_street" IS 'Street address for auto-filling job applications';



COMMENT ON COLUMN "public"."profiles"."address_city" IS 'City for auto-filling job applications';



COMMENT ON COLUMN "public"."profiles"."address_state" IS 'State for auto-filling job applications';



COMMENT ON COLUMN "public"."profiles"."address_zip_code" IS 'Zip code for auto-filling job applications';



COMMENT ON COLUMN "public"."profiles"."authorized_to_work" IS 'Work authorization status for auto-filling applications';



COMMENT ON COLUMN "public"."profiles"."has_drivers_license" IS 'Drivers license status for auto-filling applications';



COMMENT ON COLUMN "public"."profiles"."license_class" IS 'Drivers license class (A, B, or C) for auto-filling applications';



COMMENT ON COLUMN "public"."profiles"."has_reliable_transportation" IS 'Transportation availability for auto-filling applications';



COMMENT ON COLUMN "public"."profiles"."years_of_experience" IS 'Years of experience in trade for auto-filling applications';



COMMENT ON COLUMN "public"."profiles"."trade_skills" IS 'Array of trade skills for auto-filling applications';



COMMENT ON COLUMN "public"."profiles"."emergency_contact_name" IS 'Emergency contact name for auto-filling applications';



COMMENT ON COLUMN "public"."profiles"."emergency_contact_relationship" IS 'Emergency contact relationship for auto-filling applications';



COMMENT ON COLUMN "public"."profiles"."emergency_contact_phone" IS 'Emergency contact phone for auto-filling applications';



COMMENT ON COLUMN "public"."profiles"."profile_image_url" IS 'Public URL of user profile picture from Supabase Storage';



COMMENT ON COLUMN "public"."profiles"."is_admin" IS 'Grants access to /admin/* routes';



COMMENT ON COLUMN "public"."profiles"."can_post_jobs" IS 'Controls job posting ability (false for workers and recruiters)';



COMMENT ON COLUMN "public"."profiles"."has_tools" IS 'Whether worker has marked they own their own tools';



COMMENT ON COLUMN "public"."profiles"."tools_owned" IS 'List of tools owned by the worker (free-form text array)';


 TO 
COMMENT ON COLUMN "public"."profiles"."is_lifetime_pro" IS 'Lifetime Pro status (granted manually, never expires)';



COMMENT ON COLUMN "public"."profiles"."lifetime_pro_granted_at" IS 'Timestamp when lifetime Pro was granted';



COMMENT ON COLUMN "public"."profiles"."lifetime_pro_granted_by" IS 'Admin who granted lifetime Pro status';



COMMENT ON CONSTRAINT "profiles_employer_type_check" ON "public"."profiles" IS 'Employer types: contractor (licensed to contract jobs), developer (big projects), homeowner (individuals with homes), recruiter (staffing agencies)';
...
CREATE TABLE IF NOT EXISTS "public"."subscriptions" (
    ...
    "subscription_price" NOT NULL,
    "subscription_start" timestamp with time zone NOT NULL,
    "subscription_end" timestamp with time zone NOT NULL,
    "cancel_at_period_end" boolean DEFAULT false NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "subscriptions_plan_type_check" CHECK (("plan_type" = ANY (ARRAY['monthly'::"text", 'annual'::"text"]))),
    CONSTRAINT "subscriptions_status_check" CHECK (("status" = ANY (ARRAY['active'::"text", 'canceled'::"text", 'past_due'::"text", 'incomplete'::"text", 'incomplete_expired'::"text", 'trialing'::"text", 'unpaid'::"text", 'paused'::"text"])))
);
...
COMMENT ON TABLE "public"."user_moderation_actions" IS 'User moderation history (warnings, suspensions, bans)';



COMMENT ON COLUMN "public"."user_moderation_actions"."action_type" IS 'Type: warning, suspension, ban, unbanned';



COMMENT ON COLUMN "public"."user_moderation_actions"."duration_days" IS 'For temporary suspensions (NULL = permanent ban)';
...
COMMENT ON COLUMN "public"."work_experience"."is_current" IS 'Whether this is current employment for auto-filling applications';



COMMENT ON COLUMN "public"."work_experience"."responsibilities" IS 'Job responsibilities for auto-filling applications';



COMMENT ON COLUMN "public"."work_experience"."reason_for_leaving" IS 'Reason for leaving job for auto-filling applications';
...
ALTER TABLE ONLY "public"."application_drafts"
    ADD CONSTRAINT "application_drafts_job_id_worker_id_key" UNIQUE ("job_id", "applicant_id");
...
ALTER TABLE ONLY "public"."proximity_alerts"
    ADD CONSTRAINT "unique_alert" UNIQUE ("user_id", "job_id");



ALTER TABLE ONLY "public"."job_applications"
    ADD CONSTRAINT "unique_application" UNIQUE ("job_id", "applicant_id");
...
ALTER TABLE ONLY "public"."portfolio_images"
    ADD CONSTRAINT "unique_user_order" UNIQUE ("user_id", "display_order");



ALTER TABLE ONLY "public"."job_views"
    ADD CONSTRAINT "unique_view" UNIQUE ("job_id", "user_id");
...
CREATE INDEX "idx_admin_activity_date" ON "public"."admin_activity_log" USING "btree" ("created_at" DESC);
...
CREATE INDEX "idx_application_drafts_applicant" ON "public"."application_drafts" USING "btree" ("applicant_id");



CREATE INDEX "idx_application_drafts_expires" ON "public"."application_drafts" USING "btree" ("expires_at");



CREATE INDEX "idx_application_drafts_job" ON "public"."application_drafts" USING "btree" ("job_id");



CREATE INDEX "idx_certifications_category" ON "public"."certifications" USING "btree" ("credential_category");



CREATE INDEX "idx_certifications_expires_at" ON "public"."certifications" USING "btree" ("expires_at") WHERE ("expires_at" IS NOT NULL);



CREATE INDEX "idx_certifications_issuing_state" ON "public"."certifications" USING "btree" ("issuing_state");



CREATE INDEX "idx_certifications_type" ON "public"."certifications" USING "btree" ("certification_type");
...
CREATE INDEX "idx_certifications_verification_status" ON "public"."certifications" USING "btree" ("verification_status");



CREATE INDEX "idx_certifications_verified_by" ON "public"."certifications" USING "btree" ("verified_by");



CREATE INDEX "idx_content_reports_date" ON "public"."content_reports" USING "btree" ("created_at" DESC);
...
CREATE INDEX "idx_endorsement_requests_employer_id" ON "public"."endorsement_requests" USING "btree" ("employer_id", "status");



CREATE INDEX "idx_endorsement_requests_experience_id" ON "public"."endorsement_requests" USING "btree" ("experience_id");



CREATE INDEX "idx_endorsement_requests_worker_id" ON "public"."endorsement_requests" USING "btree" ("worker_id");



CREATE INDEX "idx_endorsements_endorsed_by_user_id" ON "public"."endorsements" USING "btree" ("endorsed_by_user_id");



CREATE INDEX "idx_endorsements_experience_id" ON "public"."endorsements" USING "btree" ("experience_id");
...
CREATE INDEX "idx_job_applications_job_status" ON "public"."job_applications" USING "btree" ("job_id", "status");
...
CREATE INDEX "idx_job_applications_worker_created" ON "public"."job_applications" USING "btree" ("applicant_id", "created_at" DESC);
...
CREATE INDEX "idx_job_views_viewer_id" ON "public"."job_views" USING "btree" ("viewer_id");
...
CREATE INDEX "idx_jobs_subtrade_pay_rates" ON "public"."jobs" USING "gin" ("subtrade_pay_rates");



CREATE INDEX "idx_jobs_trade" ON "public"."jobs" USING "btree" ("trade");
...
CREATE INDEX "idx_notifications_read_at" ON "public"."notifications" USING "btree" ("user_id", "read_at") WHERE ("read_at" IS NULL);
...
CREATE INDEX "idx_portfolio_images_user_id" ON "public"."portfolio_images" USING "btree" ("user_id");
...
CREATE INDEX "idx_profile_views_viewed_profile" ON "public"."profile_views" USING "btree" ("viewed_profile_id", "viewed_at" DESC);



CREATE INDEX "idx_profile_views_viewed_profile_id" ON "public"."profile_views" USING "btree" ("viewed_profile_id", "viewed_at" DESC);
...
CREATE INDEX "idx_profiles_coords" ON "public"."profiles" USING "gist" ("coords");



CREATE INDEX "idx_profiles_is_profile_boosted" ON "public"."profiles" USING "btree" ("is_profile_boosted", "created_at" DESC);



CREATE INDEX "idx_profiles_lifetime_pro" ON "public"."profiles" USING "btree" ("is_lifetime_pro") WHERE ("is_lifetime_pro" = true);
...
CREATE INDEX "idx_profiles_trade" ON "public"."profiles" USING "btree" ("trade");



CREATE INDEX "idx_proximity_alerts_job_id" ON "public"."proximity_alerts" USING "btree" ("job_id");



CREATE INDEX "idx_proximity_alerts_user_id" ON "public"."proximity_alerts" USING "btree" ("user_id");
...
CREATE INDEX "idx_user_moderation_expires" ON "public"."user_moderation_actions" USING "btree" ("expires_at") WHERE ("expires_at" IS NOT NULL);



CREATE INDEX "idx_user_moderation_user" ON "public"."user_moderation_actions" USING "btree" ("user_id");
...
CREATE OR REPLACE TRIGGER "endorsement_count_trigger" AFTER INSERT OR DELETE ON "public"."endorsements" FOR EACH ROW EXECUTE FUNCTION "public"."update_endorsement_count"();



CREATE OR REPLACE TRIGGER "enforce_credential_category" BEFORE INSERT OR UPDATE ON "public"."certifications" FOR EACH ROW EXECUTE FUNCTION "public"."check_credential_category"();



CREATE OR REPLACE TRIGGER "enforce_portfolio_limit" BEFORE INSERT ON "public"."portfolio_images" FOR EACH ROW EXECUTE FUNCTION "public"."check_portfolio_limit"();



COMMENT ON TRIGGER "enforce_portfolio_limit" ON "public"."portfolio_images" IS 'Prevents race conditions by enforcing 5-photo limit for free users at database level';



CREATE OR REPLACE TRIGGER "increment_applications" AFTER INSERT ON "public"."job_applications" FOR EACH ROW EXECUTE FUNCTION "public"."increment_application_count"();



CREATE OR REPLACE TRIGGER "increment_job_views" AFTER INSERT ON "public"."job_views" FOR EACH ROW EXECUTE FUNCTION "public"."increment_job_view_count"();



CREATE OR REPLACE TRIGGER "on_profile_created_create_notification_preferences" AFTER INSERT ON "public"."profiles" FOR EACH ROW EXECUTE FUNCTION "public"."create_default_notification_preferences"();
...
CREATE OR REPLACE TRIGGER "update_proximity_alerts_updated_at" BEFORE UPDATE ON "public"."proximity_alerts" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
ALTER TABLE ONLY "public"."application_drafts"
    ADD CONSTRAINT "application_drafts_applicant_id_fkey" FOREIGN KEY ("applicant_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."certifications"
    ADD CONSTRAINT "certifications_verified_by_fkey" FOREIGN KEY ("verified_by") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."conversations"
    ADD CONSTRAINT "conversations_participant_1_id_fkey" FOREIGN KEY ("participant_1_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."conversations"
    ADD CONSTRAINT "conversations_participant_2_id_fkey" FOREIGN KEY ("participant_2_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."endorsement_requests"
    ADD CONSTRAINT "endorsement_requests_employer_id_fkey" FOREIGN KEY ("employer_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."endorsement_requests"
    ADD CONSTRAINT "endorsement_requests_worker_id_fkey" FOREIGN KEY ("worker_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."endorsements"
    ADD CONSTRAINT "endorsements_endorsed_by_user_id_fkey" FOREIGN KEY ("endorsed_by_user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."job_views"
    ADD CONSTRAINT "job_views_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."job_views"
    ADD CONSTRAINT "job_views_viewer_id_fkey" FOREIGN KEY ("viewer_id") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."portfolio_images"
    ADD CONSTRAINT "portfolio_images_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."professional_references"
    ADD CONSTRAINT "professional_references_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."profiles"
    ADD CONSTRAINT "profiles_lifetime_pro_granted_by_fkey" FOREIGN KEY ("lifetime_pro_granted_by") REFERENCES "public"."profiles"("id");



ALTER TABLE ONLY "public"."proximity_alerts"
    ADD CONSTRAINT "proximity_alerts_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "public"."jobs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."proximity_alerts"
    ADD CONSTRAINT "proximity_alerts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."user_moderation_actions"
    ADD CONSTRAINT "user_moderation_actions_actioned_by_fkey" FOREIGN KEY ("actioned_by") REFERENCES "public"."profiles"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."user_moderation_actions"
    ADD CONSTRAINT "user_moderation_actions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
COMMENT ON POLICY "Admins can update certifications 
for verification" 
    ON "public"."certifications" IS 'Admin users can update verification status, notes, and other fields';
...
CREATE POLICY "Admins can update settings" 
    ON "public"."platform_settings" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."is_admin" = true)))));
...
COMMENT ON POLICY "Admins can view all certifications" 
    ON "public"."certifications" IS 'Admin users can view all certifications 
    for verification';
...
CREATE POLICY "Employers can create endorsements" 
    ON "public"."endorsements" 
    FOR INSERT TO "authenticated" WITH CHECK (("endorsed_by_user_id" = "auth"."uid"()));
...
CREATE POLICY "Employers can update endorsement requests" 
    ON "public"."endorsement_requests" 
...
CREATE POLICY "Endorsers can update their endorsements" 
    ON "public"."endorsements" 
    FOR UPDATE TO "authenticated" USING (("endorsed_by_user_id" = "auth"."uid"()));



CREATE POLICY "Everyone can view active jobs" 
    ON "public"."jobs" 
    FOR SELECT USING ((("status" = 'active'::"text") OR ("employer_id" = "auth"."uid"())));
...
CREATE POLICY "Pro workers can create endorsement requests" 
    ON "public"."endorsement_requests" 
    FOR INSERT TO "authenticated" WITH CHECK ((("worker_id" = "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."profiles"
  WHERE (("profiles"."id" = "auth"."uid"()) AND ("profiles"."role" = 'worker'::"text") AND ("profiles"."subscription_status" = 'pro'::"text"))))));
...
CREATE POLICY "Users can delete their own professional_references" 
...
CREATE POLICY "Users can insert messages in their conversations" 
    ON "public"."messages" 
    FOR INSERT WITH CHECK ((("auth"."uid"() = "sender_id") AND (EXISTS ( SELECT 1
...
CREATE POLICY "Users can insert their own professional_references" 
    ON "public"."professional_references" 
    FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update their own professional_references" 
    ON "public"."professional_references" 
    FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view endorsement requests they're involved in" 
    ON "public"."endorsement_requests" 
    FOR SELECT TO "authenticated" USING ((("worker_id" = "auth"."uid"()) OR ("employer_id" = "auth"."uid"())));
...
CREATE POLICY "Users can view own applications" 
    ON "public"."job_applications" 
    FOR SELECT USING ((("auth"."uid"() = "applicant_id") OR (EXISTS ( SELECT 1
   FROM "public"."jobs"
  WHERE (("jobs"."id" = "job_applications"."job_id") AND ("jobs"."employer_id" = "auth"."uid"()))))));
...
COMMENT 
    ON POLICY "Users can view own certifications" 
    ON "public"."certifications" IS 'Users can view their own certification records';
...
CREATE POLICY "Users can view their own professional_references" 
    ON "public"."professional_references" 
    FOR SELECT USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users manage own notification preferences" 
    ON "public"."notification_preferences" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));



CREATE POLICY "Workers and employers can update applications" 
    ON "public"."job_applications" 
    FOR UPDATE USING ((("auth"."uid"() = "applicant_id") OR ("auth"."uid"() IN ( SELECT "jobs"."employer_id"
   FROM "public"."jobs"
...
CREATE POLICY "Workers can view their own applications" 
    ...
    USING (((
        ...
        "auth"."uid"() IN (SELECT "jobs"."employer_id" FROM "public"."jobs" WHERE ("jobs"."id" = "job_applications"."job_id")))));
...
GRANT ALL ON FUNCTION "public"."calculate_total_experience"("p_user_id" "uuid", "p_trade_filter" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."calculate_total_experience"("p_user_id" "uuid", "p_trade_filter" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."calculate_total_experience"("p_user_id" "uuid", "p_trade_filter" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."can_access_pro_features"("user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."can_access_pro_features"("user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_access_pro_features"("user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."check_credential_category"() TO "anon";
GRANT ALL ON FUNCTION "public"."check_credential_category"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_credential_category"() TO "service_role";



GRANT ALL ON FUNCTION "public"."check_portfolio_limit"() TO "anon";
GRANT ALL ON FUNCTION "public"."check_portfolio_limit"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_portfolio_limit"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_pay_rate" "text", "p_sub_trade" "text", "p_pay_min" numeric, "p_pay_max" numeric, "p_required_certs" "text"[], "p_time_length" "text", "p_trades" "text"[], "p_sub_trades" "text"[], "p_trade_selections" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_pay_rate" "text", "p_sub_trade" "text", "p_pay_min" numeric, "p_pay_max" numeric, "p_required_certs" "text"[], "p_time_length" "text", "p_trades" "text"[], "p_sub_trades" "text"[], "p_trade_selections" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_job_with_coords"("p_employer_id" "uuid", "p_title" "text", "p_trade" "text", "p_job_type" "text", "p_description" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_pay_rate" "text", "p_sub_trade" "text", "p_pay_min" numeric, "p_pay_max" numeric, "p_required_certs" "text"[], "p_time_length" "text", "p_trades" "text"[], "p_sub_trades" "text"[], "p_trade_selections" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_nearby_jobs"("user_lng" double precision, "user_lat" double precision, "radius_km" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."get_nearby_jobs"("user_lng" double precision, "user_lat" double precision, "radius_km" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_nearby_jobs"("user_lng" double precision, "user_lat" double precision, "radius_km" double precision) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_workers_by_experience"("p_min_years" integer, "p_trade_filter" "text", "p_limit_count" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."get_workers_by_experience"("p_min_years" integer, "p_trade_filter" "text", "p_limit_count" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_workers_by_experience"("p_min_years" integer, "p_trade_filter" "text", "p_limit_count" integer) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."increment_application_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."increment_application_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."increment_application_count"() TO "service_role";



GRANT ALL ON FUNCTION "public"."increment_job_view_count"() TO "anon";
GRANT ALL ON FUNCTION "public"."increment_job_view_count"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."increment_job_view_count"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."mark_conversation_read"("conversation_id" "uuid", "user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."mark_conversation_read"("conversation_id" "uuid", "user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."mark_conversation_read"("conversation_id" "uuid", "user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."st_distance"("geog1" "jsonb", "geog2" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."st_distance"("geog1" "jsonb", "geog2" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."st_distance"("geog1" "jsonb", "geog2" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_profile_coords"("p_user_id" "uuid", "p_name" "text", "p_phone" "text", "p_email" "text", "p_role" "text", "p_trade" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_bio" "text", "p_sub_trade" "text", "p_employer_type" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_profile_coords"("p_user_id" "uuid", "p_name" "text", "p_phone" "text", "p_email" "text", "p_role" "text", "p_trade" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_bio" "text", "p_sub_trade" "text", "p_employer_type" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_profile_coords"("p_user_id" "uuid", "p_name" "text", "p_phone" "text", "p_email" "text", "p_role" "text", "p_trade" "text", "p_location" "text", "p_lng" double precision, "p_lat" double precision, "p_bio" "text", "p_sub_trade" "text", "p_employer_type" "text") TO "service_role";
GRANT ALL ON FUNCTION "public"."update_profile_coords_only"("p_user_id" "uuid", "p_lng" double precision, "p_lat" double precision) TO "anon";
GRANT ALL ON FUNCTION "public"."update_profile_coords_only"("p_user_id" "uuid", "p_lng" double precision, "p_lat" double precision) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_profile_coords_only"("p_user_id" "uuid", "p_lng" double precision, "p_lat" double precision) TO "service_role";
